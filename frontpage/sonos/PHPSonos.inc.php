<?php
// URL http://192.168.0.5:82/user/PhpDocumentor/

/**
 * PHPSonos.inc.php
 *
 * PHPSonos Class orignally released as: Sonos PHP Script - Copyright: Michael Maroszek - Version: 1.0, 09.07.2009
 *
 ...
 * - 110909 - br found send off commented out in RemoveMember and reenabled the sending now (TEST?!)
...
'. $xml;
  return $this->sendPacket($content); // @todo br 20110909 this Line was commented out; i dont understand why... chenged this
 ...
 * - <b>WSDL:</b> fill in
 * - <b>Service:</b> urn:schemas-upnp-org:service:AVTransport:1
 * - <b>Returns:</b> Void; should be sendpacket contents
 *
 * @return Void
 */
 ...
 * - <b>WSDL:</b> fill in
 * - <b>Service:</b> urn:schemas-upnp-org:service:AVTransport:1
 * - <b>Returns:</b> String; should be sendpacket Return
 *
 ...
 * Play Radio station
 *
 * - <b>NOTE:</b> This is only a SetAVTTransportURI Wrapper
 *
 * - <b>Device:</b> urn:schemas-upnp-org:device:MediaRenderer:1
 * - <b>WSDL:</b> fill in
 * - <b>Service:</b> urn:schemas-upnp-org:service:AVTransport:1
 ...
 *
 * - <b>NOTE:</b> Main SOAP method to set play URI - this is SetAVTTransportURI
 *
 * - <b>Device:</b> urn:schemas-upnp-org:device:MediaRenderer:1
 * - <b>WSDL:</b> fill in
 * - <b>Service:</b> urn:schemas-upnp-org:service:AVTransport:1
...
/**
 * 
 Get Now Playing information from Radiotime via opml (TEST)
 *
				   ...
				   // Only Ask Radiotime / Tunein for valid stationids (!!)
					if (($station!="")and $station[0]=="s"){
					   // Ask with PHPSonos PartnerID and serial (mac)
						...
						// DEBUG for Intune-Throttling (or blocking!)
